...
type udpVerdict Verdict

const (
	udpVerdictAccept       = udpVerdict(VerdictAccept)
	udpVerdictAcceptModify = udpVerdict(VerdictAcceptModify)
	udpVerdictAcceptStream = udpVerdict(VerdictAcceptStream)
	udpVerdictDrop         = udpVerdict(VerdictDrop)
	udpVerdictDropStream   = udpVerdict(VerdictDropStream)
)
